...
(function ($) {
  ...
  var transitionsSupported = function () {
    ...
    // delete div;
    div = null; // do not delete local var in strict mode
  ...
  $.widget('lj.sidePane', $.lj.basicWidget, {
    ...
    _create: function _create() {
      ...
      var widget = this;
      this._on('sidePane/close', function () {
        widget.close();
      });
    ...
    _bindControls: function _bindControls() {
      ...
      this.element.find(this.options.selectors.toggle).click(function () {
    ...
    _setOption: function _setOption(name, val) {
      switch (name) {
        case 'visibility':
          if (val === 'hidden') {
            this.hide();
    ...
    show: function show() {
      ...
      if (transitionsSupported) {
        this.element.removeClass(this.options.classNames.hidden);
      } else {
        ...
        this._inner.animate({
          ...
          complete: function complete() {
            widget.element.removeClass(widget.options.classNames.hidden);
    ...
    hide: function hide() {
      ...
      if (transitionsSupported) {
        this.element.removeClass(this.options.classNames.open).addClass(this.options.classNames.hidden);
      } else {
        this._inner.animate({
          left: '100%',
          marginLeft: '4px'
          ...
          duration: 300,
          complete: function complete() {
            widget.element.removeClass(widget.options.classNames.open).addClass(widget.options.classNames.hidden);
    ...
    open: function open() {
      ...
      if (transitionsSupported) {
        ...
        this._inner.css({ marginLeft: '0px' }).animate({
          ...
          queue: true,
          complete: function complete() {
            widget.element.addClass(widget.options.classNames.open);
    ...
    close: function close() {
      ...
      if (transitionsSupported) {
        ...
        this._inner.css({ marginLeft: '-47px' }).animate({
          ...
          duration: 300,
          complete: function complete() {
            widget.element.removeClass(widget.options.classNames.open);
...
//# map link was there [jquery.lj.sidePane.js.map]
